    ...
    if CurrentMenu ~= nil and CurrentMenu() then
        ...
        if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
            ...
            if Enabled then
                ...
                if Style.LeftLabel then
                    RenderText(Style.LeftLabel, CurrentMenu.X + SettingsButton.LeftText.X - RightBadgeOffset + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.LeftText.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, SettingsButton.LeftText.Scale, Active and 0 or 245, Active and 0 or 245, Active and 0 or 245, 255, 2)
                end
